...
class LEDPin {
	private:
		...
		/* If the Pin should output black */
	...
	public:
		...
		/* Sets this pin to output color instead of black (default behavior) */
		void enable() {this->isTurnedOff = false;}
		/* Sets this pin to output black on all LEDs instead */
		void disable() {this->isTurnedOff = true;}
};
